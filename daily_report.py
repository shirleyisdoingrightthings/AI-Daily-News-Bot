...
- 小标题必须是该条信息的核心事实或数据，不是分类标签。判断标准：去掉小标题后读者是否还能理解这条 Detail 的主题？能理解就说明小标题没有信息量，必须重写。
- 禁止标签型小标题（如"背景关联""行业现象""竞争背景""政策边界"）；应把关键数字、主体动作或结果直接写进小标题（如"<b>$400亿、现金+算力</b>"而非"<b>投资规模</b>"，"<b>TML 背景：前 OpenAI 研究员创立</b>"而非"<b>竞争背景</b>"）
